...
> 用前请先备份存档。
>
> 作者 **[@huxc573](https://github.com/huxc573)** · 开源协议 **MIT** · 当前版本 **v0.5.1**
...
打包产物在 `dist\`：`画迹2存档工具v0.5.1.exe` + `XJCodec32.exe`（**必须挨着 exe**，
...
> `Huaji2SaveTool_v0.5.1.exe` + `USAGE.txt`（内容与 `dist\画迹2存档工具v0.5.1.exe` /
> `使用说明.txt` 相同）。
